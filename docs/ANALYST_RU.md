...
ZIP / 7z / RAR не распаковываются — ни с паролем, ни без. Сигнал: тип архива, шифрование, имена файлов из каталога (двойное расширение, опасный тип, вложенное письмо). Содержимое членов разбирается отдельно в песочнице. Упоминание пароля в теле усиливает сигнал (`archive_password_match`). ПКМ → «Заметка: шифрованный архив» для тикета.
